...
.player {display:flex;align-items:center;gap:10px;min-width:0;font-size:22px;font-weight:750;line-height:1.25;margin:8px 0;overflow-wrap:anywhere}.player .pick-headshot{flex:0 0 56px;margin-right:0}
