...
.prop-row {border-top:1px solid #26364b;margin-top:14px;padding-top:14px}.prop-summary {display:flex;align-items:center;justify-content:space-between;gap:12px;min-width:0}.prop-summary strong {font-size:26px;font-variant-numeric:tabular-nums}.prop-details summary {cursor:pointer;min-height:44px;display:flex;align-items:center;color:#9babc0;font-size:13px}.prop-details .muted {padding-bottom:8px}
