...
button {min-height:44px;border-radius:10px!important;touch-action:manipulation}.stButton>button{background:#111b29;border:1px solid #38506c;color:#ecf2fa;transition:border-color .15s ease,background .15s ease}.stButton>button:hover{background:#17263a;border-color:#77dac6;color:#ffffff} button:focus-visible,input:focus-visible,select:focus-visible,[role="combobox"]:focus-visible{outline:3px solid #77dac6!important;outline-offset:2px} [data-testid="stRadio"] {background:#101925;border-radius:12px;padding:8px}[data-testid="stCheckbox"] label{min-height:44px;align-items:center}[data-testid="stTextInput"] input,[data-testid="stNumberInput"] input,[data-baseweb="select"]>div{background:#111b29;border:1px solid #26364b;color:#ecf2fa;border-radius:10px}[data-testid="stTextInput"] input::placeholder,[data-testid="stNumberInput"] input::placeholder{color:#8fa1b8;opacity:1}[data-baseweb="popover"]{background:#111b29;color:#ecf2fa}[data-baseweb="popover"] [role="listbox"]{max-height:50vh;overflow-y:auto}[data-baseweb="popover"] [role="option"]{color:#ecf2fa}[data-baseweb="popover"] [role="option"]:hover{background:#17263a}
