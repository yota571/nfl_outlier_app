...
.card {background:#141e2c;border:1px solid #26364b;border-radius:18px;padding:18px;margin:12px 0}[data-testid="stExpander"]{border:1px solid #26364b;border-radius:12px;overflow:hidden;background:#0f1622}[data-testid="stExpander"] summary{min-height:44px;padding:0 12px}
