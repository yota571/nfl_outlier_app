...
.line {display:flex;align-items:baseline;gap:6px;min-width:0;flex-wrap:wrap;font-size:32px;font-weight:750;color:#f5f8fc;margin-top:8px;font-variant-numeric:tabular-nums}
