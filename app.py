...
.pick-headshot {display:block;width:56px;height:56px;border-radius:10px;object-fit:cover;vertical-align:middle;margin-right:9px;border:1px solid #38506c;background:#17263a}.pick-title {display:flex;align-items:center}
