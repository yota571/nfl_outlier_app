...
h1 {font-size:clamp(1.65rem,4vw,2rem)!important;letter-spacing:-.06rem} h2,h3{margin-top:1.15rem!important}h3 {font-size:1.1rem!important}hr{border-color:#26364b}[data-baseweb="tab-list"]{gap:4px;border-bottom:1px solid #26364b;overflow-x:auto;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain;scrollbar-width:none}[data-baseweb="tab-list"]::-webkit-scrollbar{display:none}[data-baseweb="tab"]{color:#9babc0;padding:8px 10px;white-space:nowrap}[data-baseweb="tab"][aria-selected="true"]{color:#77dac6;border-bottom-color:#77dac6}a{color:#70b8ff;text-decoration:none}a:hover,a:focus-visible{text-decoration:underline;color:#9bd0ff}
