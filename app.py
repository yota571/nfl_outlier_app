...
h1 {font-size:2rem!important;letter-spacing:-.06rem} h3 {font-size:1.1rem!important}hr{border-color:#26364b}[data-baseweb="tab-list"]{gap:4px;border-bottom:1px solid #26364b}[data-baseweb="tab"]{color:#9babc0;padding:8px 10px}[data-baseweb="tab"][aria-selected="true"]{color:#77dac6;border-bottom-color:#77dac6}a{color:#70b8ff;text-decoration:none}a:hover,a:focus-visible{text-decoration:underline;color:#9bd0ff}
