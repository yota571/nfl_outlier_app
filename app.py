...
st.markdown('''<style>
*,*:before,*:after{box-sizing:border-box}html,body{overscroll-behavior-x:none;line-height:1.45;-webkit-text-size-adjust:100%;text-size-adjust:100%;scrollbar-gutter:stable;scroll-behavior:smooth;scroll-padding-top:1rem;scroll-padding-bottom:7rem}::selection{background:#2f6f70;color:#ffffff}img{max-width:100%}input,select,textarea{font-size:16px;line-height:1.35}input,textarea{caret-color:#77dac6}input,textarea,select{accent-color:#77dac6}.stApp {background:#0b1018;color:#ecf2fa;color-scheme:dark;-webkit-tap-highlight-color:transparent;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased}.stSpinner>div{color:#77dac6}::-webkit-scrollbar{width:8px}::-webkit-scrollbar-track{background:#0b1018}::-webkit-scrollbar-thumb{background:#26364b;border-radius:999px}::-webkit-scrollbar-thumb:hover{background:#38506c}
.block-container {max-width:850px;padding-top:1.2rem;padding-bottom:5rem}
h1 {font-size:clamp(1.65rem,4vw,2rem)!important;letter-spacing:-.06rem;text-wrap:balance} h2,h3{margin-top:1.15rem!important;text-wrap:balance}h3 {font-size:1.1rem!important}hr{border-color:#26364b}[data-baseweb="tab-list"]{gap:4px;border-bottom:1px solid #26364b;overflow-x:auto;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain;scroll-padding-inline:12px;scroll-snap-type:x proximity;scrollbar-width:none}[data-baseweb="tab-list"]::-webkit-scrollbar{display:none}[data-baseweb="tab"]{color:#9babc0;padding:8px 10px;white-space:nowrap;scroll-snap-align:start}[data-baseweb="tab"][aria-selected="true"]{color:#77dac6;border-bottom-color:#77dac6;font-weight:700}\n[data-baseweb="tab"]:focus-visible{outline:3px solid #77dac6;outline-offset:-3px;border-radius:6px}a{color:#70b8ff;text-decoration:none;text-underline-offset:3px}a:hover,a:focus-visible{text-decoration:underline;color:#9bd0ff}
header[data-testid="stHeader"] {background:#0b1018}
.card {contain:layout paint;content-visibility:auto;contain-intrinsic-size:220px;overflow:hidden;background:#141e2c;background-clip:padding-box;border:1px solid #26364b;border-radius:18px;padding:18px;margin:12px 0;box-shadow:0 6px 18px rgba(0,0,0,.14);transition:transform .15s ease,box-shadow .15s ease,border-color .15s ease}[data-testid="stDataFrame"]{border:1px solid #26364b;border-radius:12px;overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain;overscroll-behavior-y:contain;scrollbar-width:thin;scrollbar-color:#38506c #0b1018;will-change:scroll-position;touch-action:pan-x pan-y}[data-testid="stMetric"]{background:#141e2c;border:1px solid #26364b;border-radius:14px;padding:10px 12px}\n[data-testid="stMetricValue"]{font-variant-numeric:tabular-nums}[data-testid="stAlert"]{border-radius:12px;overflow-wrap:anywhere;word-break:break-word;text-wrap:pretty;line-height:1.5}@media(hover:hover){.card:hover{transform:translateY(-1px);box-shadow:0 9px 24px rgba(0,0,0,.22)}}.card:focus-within{border-color:#38506c}[data-testid="stExpander"]{border:1px solid #26364b;border-radius:12px;overflow:hidden;background:#0f1622}[data-testid="stExpander"] summary{min-height:44px;padding:0 12px;cursor:pointer;user-select:none;touch-action:manipulation}[data-testid="stExpander"] summary:focus-visible{outline:3px solid #77dac6;outline-offset:-3px}[data-testid="stExpander"] details[open] summary{border-bottom:1px solid #26364b}
.eyebrow {font-size:11px;line-height:1.3;letter-spacing:.13em;text-transform:uppercase;color:#77dac6;font-weight:700}
.player {display:flex;align-items:center;gap:10px;min-width:0;font-size:22px;font-weight:750;line-height:1.25;margin:8px 0;overflow-wrap:anywhere;text-wrap:balance}.player .pick-headshot{flex:0 0 56px;margin-right:0}
...
.line {display:flex;align-items:baseline;gap:6px;min-width:0;flex-wrap:wrap;font-size:32px;overflow-wrap:anywhere;font-weight:750;color:#f5f8fc;margin-top:8px;font-variant-numeric:tabular-nums}
.badge {display:inline-flex;align-items:center;width:max-content;max-width:100%;color:#e8c78a;background:#2b2f3d;border:1px solid #4b5363;border-radius:999px;padding:5px 9px;font-size:12px;font-weight:650;margin-top:8px}
...
.pick-headshot {display:block;width:56px;height:56px;aspect-ratio:1/1;border-radius:10px;object-fit:cover;object-position:center top;vertical-align:middle;margin-right:9px;border:1px solid #38506c;background:#17263a}.pick-title {display:flex;align-items:center}
.prop-row {border-top:1px solid #26364b;margin-top:14px;padding-top:14px}.prop-summary {display:flex;align-items:center;justify-content:space-between;gap:12px;min-width:0}.prop-summary strong {font-size:26px;font-variant-numeric:tabular-nums;overflow-wrap:anywhere}.prop-details summary {cursor:pointer;min-height:44px;display:flex;align-items:center;color:#9babc0;font-size:13px}.prop-details .muted {padding-bottom:8px}
.mini-chart-wrap{margin-top:10px;padding-top:8px;border-top:1px solid #26364b}.mini-chart{height:92px;display:flex;align-items:flex-end;gap:4px;padding:6px 2px 0;background:linear-gradient(to top,rgba(119,218,198,.08),transparent);border-bottom:1px solid #38506c}.mini-bar{position:relative;display:block;flex:1;min-width:5px;background:#20c997;border-radius:3px 3px 0 0;opacity:.9}.mini-bar-label{position:absolute;left:50%;bottom:100%;transform:translateX(-50%);font-size:10px;line-height:1.1;color:#dffaf4;font-weight:700;white-space:nowrap;padding-bottom:3px}
button {min-height:44px;border-radius:10px!important;touch-action:manipulation;line-height:1.25;white-space:normal;user-select:none;cursor:pointer}.stButton>button{background:#111b29;border:1px solid #38506c;color:#ecf2fa;font-weight:650;transition:border-color .15s ease,background .15s ease}.stButton>button:hover{background:#17263a;border-color:#77dac6;color:#ffffff}.stButton>button:active{transform:scale(.98)}[data-testid="stButton"] button[kind="primary"]{background:#159b8c;border-color:#77dac6;color:#ffffff}[data-testid="stButton"] button[kind="primary"]:hover{background:#1bb6a2}[data-testid="stButton"] button:disabled{opacity:1;cursor:not-allowed;color:#aab8c9!important;background:#17202d!important;border-color:#33465e!important} button:focus-visible,input:focus-visible,select:focus-visible,[role="combobox"]:focus-visible{outline:3px solid #77dac6!important;outline-offset:2px} [data-testid="stRadio"] {background:rgba(16,25,37,.92);border-radius:12px;padding:8px}[data-testid="stCheckbox"] label{min-height:44px;align-items:center}[data-testid="stTextInput"] input,[data-testid="stNumberInput"] input,[data-baseweb="select"]>div{background:#111b29;border:1px solid #26364b;color:#ecf2fa;border-radius:10px;line-height:1.35}\n[data-testid="stTextInput"]:focus-within input,[data-testid="stNumberInput"]:focus-within input,[data-baseweb="select"]:focus-within>div{border-color:#77dac6;box-shadow:0 0 0 2px rgba(119,218,198,.14)}[data-testid="stTextInput"] input::placeholder,[data-testid="stNumberInput"] input::placeholder{color:#8fa1b8;opacity:1}[data-baseweb="popover"]{background:#111b29;color:#ecf2fa}[data-baseweb="popover"] [role="listbox"]{max-height:50vh;overflow-y:auto;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;scrollbar-width:thin;scrollbar-color:#38506c #111b29}[data-baseweb="popover"] [role="option"]{color:#ecf2fa;min-height:40px;display:flex;align-items:center}[data-baseweb="popover"] [role="option"]:hover{background:#17263a}
...
def main():
    ...
    if nav=='Top picks':
        ...
        # removes when navigation or unavailable data hides this page.
        st.session_state['_top_picks_game_widget']=st.session_state['top_picks_game_filter']
        def remember_top_picks_game():
            st.session_state['top_picks_game_filter']=st.session_state['_top_picks_game_widget']
        game_filter=st.selectbox('Choose game / kickoff',game_options,key='_top_picks_game_widget',on_change=remember_top_picks_game,help='Limit Top picks to one matchup and kickoff.')
